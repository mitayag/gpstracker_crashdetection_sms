...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE users SET lname = '$lname', fname = '$fname', address = '$address', bloodtype = '$bloodType', 
                persontocontact = '$personToContact', addrpersontocontact = '$addressPersonToContact', 
                telnopersontocontact = '$telNoPersonToContact' WHERE ctr = $ctrno";
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <!-- // This is the panel to put the forms 
                    USER INFO
              -->
            <form method="POST" action="userinfo_edit.php">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Inputlname" name="lname" placeholder="LastName" value="<?php echo htmlspecialchars(strtoupper($row['lname'])); ?>" oninput="this.value = this.value.toUpperCase()" >
                      

                    </div>
                    <div class="form-group">
                      <label for="Inputfname">First Name</label>
                      <input type="text" class="form-control" id="Inputfname" name="fname" placeholder="FirstName" value="<?php echo htmlspecialchars(strtoupper($row['fname'])); ?>" oninput="this.value = this.value.toUpperCase()" >
                    </div>

                    <div class="form-group">
                        <label for="InputBloodType">Blood Type</label>
                        <select class="form-control" id="InputBloodType" name="bloodtype">
                            <option value="A" <?php echo ($row['bloodtype'] == 'A') ? 'selected' : ''; ?>>A</option>
                            <option value="B" <?php echo ($row['bloodtype'] == 'B') ? 'selected' : ''; ?>>B</option>
                            <option value="AB" <?php echo ($row['bloodtype'] == 'AB') ? 'selected' : ''; ?>>AB</option>
                            <option value="O" <?php echo ($row['bloodtype'] == 'O') ? 'selected' : ''; ?>>O</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="InputUserAddress" name="address" placeholder="UserAddress" value="<?php echo htmlspecialchars(strtoupper($row['address'])); ?>" oninput="this.value = this.value.toUpperCase()">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="InputPersonToContact" name="persontocontact" placeholder="PersonToContact" value="<?php echo htmlspecialchars(strtoupper($row['persontocontact'])); ?> " oninput="this.value = this.value.toUpperCase()" >
                    </div>


                    <div class="form-group">
                      <label for="InputPersonToContactAddress">Address Of Person To Contact In Case of Emegency</label>
                      <input type="text" class="form-control" id="InputPersonToContactAddress" name="addrpersontocontact" placeholder="PersonToContactAddress" value="<?php echo htmlspecialchars(strtoupper($row['addrpersontocontact'])); ?>"  oninput="this.value = this.value.toUpperCase()">
                    </div>

              
                    <div class="form-group">
                      <label for="InputPersonToContactNumber">Contact Number Of Person To Contact In Case of Emegency</label>
                      <input type="text" class="form-control" id="InputPersonToContactNumber" name="telnopersontocontact" placeholder="PersonToContactNumber" value="<?php echo htmlspecialchars(strtoupper($row['telnopersontocontact'])); ?>" oninput="this.value = this.value.toUpperCase()">
                    </div>
