                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Inputlname" placeholder="LastName" value="<?php echo htmlspecialchars(strtoupper($row['lname'])); ?>" readonly>
                      

                    </div>
                    <div class="form-group">
                      <label for="Inputfname">First Name</label>
                      <input type="text" class="form-control" id="Inputfname" placeholder="FirstName" value="<?php echo htmlspecialchars(strtoupper($row['fname'])); ?>" readonly>
                    </div>

                    <div class="form-group">
                      <label for="InputBloodType">Blood Type</label>
                      <input type="text" class="form-control" id="InputBloodType" placeholder="InputBloodType" value="<?php echo htmlspecialchars(strtoupper($row['bloodtype'])); ?>" readonly>
                    </div>

                    <div class="form-group">
                      <label for="InputUserAddress">Address</label>
                      <input type="text" class="form-control" id="InputUserAddress" placeholder="UserAddress" value="<?php echo htmlspecialchars(strtoupper($row['address'])); ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="InputPersonToContact" placeholder="PersonToContact" value="<?php echo htmlspecialchars(strtoupper($row['persontocontact'])); ?>" readonly>
                    </div>


                    <div class="form-group">
                      <label for="InputPersonToContactAddress">Address Of Person To Contact In Case of Emegency</label>
                      <input type="text" class="form-control" id="InputPersonToContactAddress" placeholder="PersonToContactAddress" value="<?php echo htmlspecialchars(strtoupper($row['addrpersontocontact'])); ?>" readonly >
                    </div>

              
                    <div class="form-group">
                      <label for="InputPersonToContactNumber">Contact Number Of Person To Contact In Case of Emegency</label>
                      <input type="text" class="form-control" id="InputPersonToContactNumber" placeholder="PersonToContactNumber" value="<?php echo htmlspecialchars(strtoupper($row['telnopersontocontact'])); ?>" readonly>
                    </div>

                    <a href="userinfo_edit.php" class="btn btn-primary me-2">Edit</a>
